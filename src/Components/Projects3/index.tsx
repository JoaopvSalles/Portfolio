        ...
        <Container>
            ...
            <div className="details">
                <div className="functions">
                    ...
                    <p>
                        <img src="../../src/assets/react.svg" alt="" /><span>Cálculo de conversão de Real para Dolar</span>
                    </p>
                    <p>
                        <img src="../../src/assets/react.svg" alt="" /><span>Integração com API do Banco do Brasil</span>
                    </p>
                </div>
